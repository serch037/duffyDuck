...
\begin{figure}[H]
  ...
  \begin{equation}
    Sn=\frac{3}{h}[f(x_0)+4f(x_1)+2f(x_2)+4fx(_3)+\dots+4f(x_{n-3})+2f(x_{n-2})+4f(x_{n-1})+f(x_n)]
  \end{equation}
...
\begin{homeworkProblem}
 ...
 \\\\
 \textbf{Solution}
 From \ref{fig3}, we can see that from our 16 measurements, we can approximate
